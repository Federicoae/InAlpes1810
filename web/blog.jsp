...
<body class="body2">
    ...
    <section class="section visit-section" id="next-section">
            ...
            <table class="table1" id="listaInmuebles">
                <tr>
                    <th id="ele"><p class="p1">UBICACION</p></th>
                    <th id="ele"><p class="p1">DIRECCION</p></th>
                    <th id="ele"><p class="p1">TIPO DE OFERTA</p></th>
                    <th id="ele"><p class="p1">DESCRIPCION</p></th>
                    <th id="ele"><p class="p1">PRECIO</p></th>
                </tr>
                <% while(resul.next()){ %>
                <tr>
                    <% String b="";
                    ...
                    <% String a="";
                    if(resul.getString("contrato").equals("1")){
                       a="Venta";
                    }else if(resul.getString("contrato").equals("2")){
                         a="Arriendo";
                    }else if(resul.getString("contrato").equals("3")){
                         a="Venta/Arriendo";
                    } %>
                    <td id="ele"><p class="p1"><%= a %></p></td>
                    <td id="ele"><p class="p1"><%= resul.getString("descripcion") %></p></td>
                    <td id="ele"><p class="p1"><%= resul.getString("precio") %></p></td>
               </tr>
                <% } %>
            </table>
        </div>
